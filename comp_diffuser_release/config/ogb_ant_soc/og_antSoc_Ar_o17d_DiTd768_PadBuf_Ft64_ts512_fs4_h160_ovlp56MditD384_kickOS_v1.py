...
base = {
    'dataset': "antsoccer-arena-stitch-v0",
    ...
    'diffusion': {
        ...
        'max_path_length': 300,
        'dataset_config': dict(
            obs_select_dim=tuple(range(17)), #### (0,1,15,16)
            dset_type='ogb',
            ###
            pad_option_2='buf',
            pad_type='first',
            ...
            # Uses global timestep indices produced by scripts/analyze_antsoccer_kicks.py.
            kick_indices_path='kick_analysis/all_kick_like_indices.npy',
            kick_oversample_prob=0.35,
            kick_window_margin=20,
        ),
