...
**This codebase is based on [OGBench](https://github.com/seohongpark/ogbench).**   

This OGBench repo is to support the experiments in the paper '[*Generative Trajectory Stitching through Diffusion Composition*](https://comp-diffuser.github.io/)'. 
The majority of the code (including the README below the horizontal bar) is from the official codebase. We add multiple components for visualization while keep the original tasks and environment dynamics identical.
